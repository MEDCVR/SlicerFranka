Fork of [frankarobotics/franka_description](https://github.com/frankarobotics/franka_description) with stl file for a [custom end effector](meshes/robot_ee/pointer/visual/pointer.stl) and generated Franka link [stl files](meshes/robot_arms/fr3/visual) for compatibility with 3D Slicer
